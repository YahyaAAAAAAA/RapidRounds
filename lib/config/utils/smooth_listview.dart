              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.only(
                    topLeft: Radius.circular(kInnerRadius),
                    bottomLeft: Radius.circular(kInnerRadius),
                  ),
                ),
                child: Icon(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: GColors.black.withValues(alpha: 0.2),
                  borderRadius: BorderRadius.only(
                    topRight: Radius.circular(kInnerRadius),
                    bottomRight: Radius.circular(kInnerRadius),
                  ),
                ),
                child: Icon(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: GColors.black.withValues(alpha: 0.2),
                  borderRadius: BorderRadius.only(
                    bottomLeft: Radius.circular(kOutterRadius),
                    bottomRight: Radius.circular(kOutterRadius),
                  ),
                ),
                child: Icon(
